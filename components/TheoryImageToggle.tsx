  ...
  return (
    <div className="mt-6 mb-2">
      <button
        ...
        className="w-full py-3 border-2 border-gray-200 rounded-2xl text-[16px] font-medium text-gray-600 hover:border-[#6D28D9] hover:text-[#6D28D9] transition-colors"
      >
        {visible ? '🙈 Skryť obrázok' : '🖼️ Zobraziť pôvodný obrázok zo zošita'}
      </button>
      {visible && (
